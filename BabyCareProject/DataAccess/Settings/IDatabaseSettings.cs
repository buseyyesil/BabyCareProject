namespace BabyCareProject.DataAccess.Settings
{
    public interface IDatabaseSettings
    {
        ...
        public string FooterInformationCollectionName { get; set; }
        public string FooterGalleryCollectionName { get; set; }
        public string FooterSubscribeCollectionName { get; set; }
    }
}
